  		...
  		<tr>
  		 <td width="5%" align="center" valign="middle" style="width:150px;">
   		 ...
   		 <td width="85%" align="left" valign="middle">
	         ...
	         <span>商品：</span>
	         	<input type="text" name="text" value="" id="select" class="text-word" placeholder="输入订单号进行查询">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">创建人</th>
      ...
      <form action="${ctx }/product/querydeleteorders" id="deleteform" method="post">  
      <input type="hidden" value="${page }">
      <c:forEach items="${orders }" var="o">
      	<tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      	<td align="center" valign="middle" class="borderright borderbottom"><input type="checkbox" name="orderid" value="${o.id }" ></td>
        <td align="center" valign="middle" class="borderright borderbottom">${o.id }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${o.date }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${o.useremail }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${o.state }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${o.address }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${o.totalprice }</td>
        <td align="center" valign="middle" class="borderbottom"><a href="${ctx }/product/detail?id=${o.id}" target="mainFrame" onFocus="this.blur()" class="add">详情</a><span class="gray">&nbsp;|&nbsp;</span><a href="${ctx }/product/deleteorders?orderid=${o.id}&page=${page }" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
      </c:forEach>
      </form>
    </table></td>
